...
void PostProsessPSO::CreateInputLayOut()
{
	inputLayoutDesc.pInputElementDescs = nullptr;
	inputLayoutDesc.NumElements = 0;
}

void PostProsessPSO::CreateBlendState()
{
	//NormalBlendに設定
...
void PostProsessPSO::CreateRasterizarState()
{
	rasterizerDesc.CullMode = D3D12_CULL_MODE_BACK;
	rasterizerDesc.FillMode = D3D12_FILL_MODE_SOLID;
}

void PostProsessPSO::CreatePipelineStateObject()
{
