#include "DrawLinePSO.h"

void DrawLinePSO::ShaderCompile()
{
	vertexShaderBlob = ShaderCompiler::GetInstance()->CompileShader(L"project/resources/hlsl/line/Line.VS.hlsl", L"vs_6_0");
	assert(vertexShaderBlob != nullptr);
	pixelShaderBlob = ShaderCompiler::GetInstance()->CompileShader(L"project/resources/hlsl/line/Line.PS.hlsl", L"ps_6_0");
}

void DrawLinePSO::CreateRootSignature()
{
	...
	rootParameters[3].Descriptor.ShaderRegister = 2;//レジスタ番号を1にバインド
...
void DrawLinePSO::CreateInputLayOut()
{
	//頂点レイアウト
...
void DrawLinePSO::CreateBlendState()
{
	//NormalBlendに設定
...
void DrawLinePSO::CreateRasterizarState()
{
	rasterizerDesc.CullMode = D3D12_CULL_MODE_BACK;
	rasterizerDesc.FillMode = D3D12_FILL_MODE_SOLID;
}

void DrawLinePSO::CreatePipelineStateObject()
{
