#include "RGBshiftPSO.h"

void RGBshiftPSO::ShaderCompile()
{
	vertexShaderBlob = ShaderCompiler::GetInstance()->CompileShader(L"project/resources/hlsl/RGBshift/RGBshift.VS.hlsl", L"vs_6_0");
	assert(vertexShaderBlob != nullptr);
	pixelShaderBlob = ShaderCompiler::GetInstance()->CompileShader(L"project/resources/hlsl/RGBshift/RGBshift.PS.hlsl", L"ps_6_0");
}

void RGBshiftPSO::CreateRootSignature()
{
...
void RGBshiftPSO::CreateInputLayOut()
{
	inputLayoutDesc.pInputElementDescs = nullptr;
	inputLayoutDesc.NumElements = 0;
}

void RGBshiftPSO::CreateBlendState()
{
	//NormalBlendに設定
...
void RGBshiftPSO::CreateRasterizarState()
{
	rasterizerDesc.CullMode = D3D12_CULL_MODE_BACK;
	rasterizerDesc.FillMode = D3D12_FILL_MODE_SOLID;
}

void RGBshiftPSO::CreatePipelineStateObject()
{
