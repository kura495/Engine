...
void PPCubeMap::CreateRootSignature()
{
	...
	rootParameters[4].Descriptor.ShaderRegister = 2;//レジスタ番号を1にバインド
...
void PPCubeMap::CreateInputLayOut()
{
	//頂点レイアウト
...
void PPCubeMap::CreateBlendState()
{
	//NormalBlendに設定
...
void PPCubeMap::CreateRasterizarState()
{
	rasterizerDesc.CullMode = D3D12_CULL_MODE_BACK;
	rasterizerDesc.FillMode = D3D12_FILL_MODE_SOLID;
}

void PPCubeMap::CreatePipelineStateObject()
{
