...
{
	vertexShaderBlob = ShaderCompiler::GetInstance()->CompileShader(L"resources/hlsl/RGBtoHSV.VS.hlsl", L"vs_6_0");
	assert(vertexShaderBlob != nullptr);
	pixelShaderBlob = ShaderCompiler::GetInstance()->CompileShader(L"resources/hlsl/RGBtoHSV.PS.hlsl", L"ps_6_0");
}
...
void RGBtoHSV::CreateRootSignature()
{
	...
	rootParameters[2].Descriptor.ShaderRegister = 1;//レジスタ番号を0にバインド
...
void RGBtoHSV::CreateInputLayOut()
{
	//頂点レイアウト
...
void RGBtoHSV::CreateBlendState()
{
	//NormalBlendに設定
...
void RGBtoHSV::CreateRasterizarState()
{
	rasterizerDesc.CullMode = D3D12_CULL_MODE_BACK;
	rasterizerDesc.FillMode = D3D12_FILL_MODE_SOLID;
}

void RGBtoHSV::CreatePipelineStateObject()
{
